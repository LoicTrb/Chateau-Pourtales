...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('extra', 1200, '', true); // Large Thumbnail
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('jquery.min', get_template_directory_uri() . '/js/jquery.min.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('jquery.min'); // Enqueue it!

        wp_register_script('bootstrap.min', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery'), '1.0.0'); // Custom scripts
        ...
        wp_register_script('wow.min', get_template_directory_uri() . '/js/wow.min.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('wow.min'); // Enqueue it!
    }
}
...
{
    if (is_front_page()) {
      wp_register_style('style-home', get_template_directory_uri() . '/style-home.css', array(), '1.0', 'all');
      wp_enqueue_style('style-home'); // Enqueue it!
    }
}
...
function html5blank_styles()
{
    ...
    wp_register_style('owl.theme.default', get_template_directory_uri() . '/css/owl.theme.default.css', array(), '1.0', 'all');
    ...
    if (is_front_page()) {
      wp_register_style('style-home', get_template_directory_uri() . '/css/style-home.css', array(), '1.0', 'all');
      wp_enqueue_style('style-home'); // Enqueue it!
    }
}
...
'description' => 'Description du post type evenement',
'public' => true,
...
'edit_item' => 'Editer une Chambre',
'new_item' => 'Nouvelle Chambre',
'all_items' => 'Toute les Chambres',
'view_item' => 'Voir Chambre',
'search_items' => 'Chercher Chambre',
'not_found' => 'Aucun Chambre trouvé',
'not_found_in_trash' => 'Aucun Chambre trouvé dans la corbeille',
'parent_item_colon' => '',
'menu_name' => 'Chambres'
);
$args = array(
'labels' => $labels,
'menu_icon' => 'dashicons-format-audio',
'description' => 'Description du post type chambre',
'public' => true,
'publicly_queryable' => true,
'show_ui' => true,
'show_in_menu' => true,
...
register_post_type('chambre', $args );
...
'edit_item' => 'Editer un forfait',
'new_item' => 'Nouveau forfait',
'all_items' => 'Tous les forfaits',
'view_item' => 'Voir forfait',
'search_items' => 'Chercher forfait',
'not_found' => 'Aucun forfait trouvé',
'not_found_in_trash' => 'Aucun forfait trouvé dans la corbeille',
'parent_item_colon' => '',
'menu_name' => 'Forfaits'
);
$args = array(
'labels' => $labels,
'menu_icon' => 'dashicons-format-audio',
'description' => 'Description du post type forfait',
'public' => true,
'publicly_queryable' => true,
'show_ui' => true,
'show_in_menu' => true,
'query_var' => true,
'rewrite' => array( 'slug' => 'forfaits' ),
'capability_type' => 'post',
'has_archive' => true,
'hierarchical' => true,
'menu_position' => null,
...
register_post_type('forfaits', $args );
